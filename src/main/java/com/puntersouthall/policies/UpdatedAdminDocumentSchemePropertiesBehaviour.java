 ...
 *
 */
public class UpdatedAdminDocumentSchemePropertiesBehaviour implements NodeServicePolicies.OnUpdatePropertiesPolicy
{

	/** the logger */
	private final Log logger = LogFactory.getLog(UpdatedAdminDocumentSchemePropertiesBehaviour.class);
	...
	*/
	...
	this.policyComponent.bindClassBehaviour(QName.createQName(NamespaceService.ALFRESCO_URI, "onUpdateProperties"),
	        QName.createQName("custom.model.jb", "adminSchemeDocument"), this.updateProperties);
	}
	...
	public void onUpdateProperties(NodeRef actionedUponNodeRef, Map<QName, Serializable> oldProps, Map<QName, Serializable> newProps)
	{
		...
		// QName for psdoc:activity
	    QName psActivityQName = QName.createQName("custom.model.jb", "activity");    
		String newActivity = (String) newProps.get(psActivityQName);
		String oldActivity = (String) oldProps.get(psActivityQName);	
		...
		if (oldSchemeID != null && newSchemeID != null){
			...
			if (oldSchemeID.equals("") || oldSchemeID.equals(newSchemeID)){
				...
				if (oldActivity != null && newActivity != null){
					if (oldActivity.equals("") || oldActivity.equals(newActivity)){
