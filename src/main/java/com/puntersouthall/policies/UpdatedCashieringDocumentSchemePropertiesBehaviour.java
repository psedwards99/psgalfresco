 ...
 *
 */
public class UpdatedCashieringDocumentSchemePropertiesBehaviour implements NodeServicePolicies.OnUpdatePropertiesPolicy
{

	/** the logger */
	private final Log logger = LogFactory.getLog(UpdatedCashieringDocumentSchemePropertiesBehaviour.class);
	...
	*/
	...
	this.policyComponent.bindClassBehaviour(QName.createQName(NamespaceService.ALFRESCO_URI, "onUpdateProperties"),
	        QName.createQName("custom.model.jb", "cashieringSchemeDocument"), this.updateProperties);
	...
	public void onUpdateProperties(NodeRef actionedUponNodeRef, Map<QName, Serializable> oldProps, Map<QName, Serializable> newProps)
	{
	    ...
	    QName psTypeQName = QName.createQName("custom.model.jb", "type");    
	    ArrayList<String> newType = (ArrayList<String>) newProps.get(psTypeQName);
	    ArrayList<String> oldType = (ArrayList<String>) oldProps.get(psTypeQName);	
		...
		if (oldSchemeID != null && newSchemeID != null){
			...
			if (oldSchemeID.equals("") || oldSchemeID.equals(newSchemeID)){
				...
				if (oldType.get(0) != null && newType.get(0) != null){
					if (oldType.get(0).equals("") || oldType.get(0).equals(newType.get(0))){
